...
$(function(){var l=new Clipboard("#copy-url"),o={longUrl:"",aliasUrl:""};$("#long-url").focus(),l.on("success",function(l){var o=$("#copy-url");o.val("Copied!"),l.clearSelection(),setTimeout(function(){o.val("Copy")},500)}),$("body").on("click",function(){$("#long-url").removeClass(),$("#short-url").removeClass()}),$("form").on("submit",function(l){l.preventDefault()}),$("#shorten-url").on("click",function(l){l.stopPropagation();var a=$("#long-url"),s=$("#alias-url"),n=$("#short-url");if(console.log(o),s.val()!==o.aliasUrl||a.val()!==o.longUrl)return o.longUrl=a.val(),o.aliasUrl=s.val(),""===$.trim(a.val())?(a.addClass("fail"),void n.removeClass("success")):void $.ajax({url:"/api/create",type:"post",dataType:"json",data:{url:a.val(),alias:$.trim(s.val())}}).done(function(l){console.log(l),l.success?(a.removeClass("fail"),n.addClass("success").val(l.domain+"/"+l.id)):(a.addClass("fail"),n.removeClass("success"))}).fail(function(l){console.log(l),a.addClass("fail"),n.removeClass("success")})}),$("#short-url").on("click",function(){var l=$(this).val().split("/")[1];l&&window.open(l)})});